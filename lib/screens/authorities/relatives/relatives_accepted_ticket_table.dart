...
class RelativesAcceptedTicketTable extends StatefulWidget {
  const RelativesAcceptedTicketTable({
    super.key,
  ...
  @override
  _RelativesAcceptedTicketTableState createState() =>
      _RelativesAcceptedTicketTableState();
}

class _RelativesAcceptedTicketTableState
    extends State<RelativesAcceptedTicketTable> {
